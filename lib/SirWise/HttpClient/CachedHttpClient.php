...
use SirWise\HttpClient\Cache\CacheInterface;
use SirWise\HttpClient\Cache\FilesystemCache;

/**
 * Performs requests on SirWise API using If-Modified-Since headers.
