...
use SuperWise\Api\ApiInterface;
use SuperWise\Api\AbstractApi;
use SuperWise\Api\Devices;
use SuperWise\Exception\InvalidArgumentException;
use SuperWise\Exception\BadMethodCallException;
use SuperWise\HttpClient\HttpClient;
use SuperWise\HttpClient\HttpClientInterface;
use SuperWise\Oauth2\GrantType\GrantTypeInterface;

/**
 * Simple PHP SuperWise client.
 *
...
class Client
{
    ...
    /**
     * The Guzzle instance used to communicate with SuperWise.
     *
     * @var HttpClient
     */
    private $httpClient;
    ...
    /**
     * Instantiate a new SuperWise client.
     *
     * @param null|HttpClientInterface $httpClient SuperWise http client
     */
